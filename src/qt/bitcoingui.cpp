    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Mooncoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Mooncoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Mooncoin Core"));
...
//#endif
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Mooncoin Core help message to get a list with possible Mooncoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Mooncoin Core client") + " " + networkStyle->getTitleAddText();
